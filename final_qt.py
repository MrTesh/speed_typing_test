...
class LeftTabWidget(QWidget):
    ...
    def initUi(self):
        ...
        item.setTextAlignment(Qt.AlignCenter)
    # содержимое страниц
        label = QLabel('This is the page 1', self)
        label.setAlignment(Qt.AlignCenter)
        label.setStyleSheet('background: rgb(15, 86, 153); color: rgb(0, 0, 0)')
        self.stackedWidget.addWidget(label)

        label = QLabel('This is the page 2', self)
        label.setAlignment(Qt.AlignCenter)
        ...
        label = QLabel('This is the page 3', self)
        label.setAlignment(Qt.AlignCenter)
        # Set the background color of the label (randomly here)
        # Added a margin margin here (to easily distinguish between QStackedWidget and QLabel colors)
        label.setStyleSheet('background: rgb(%d, %d, %d);' % (  # margin: 50px;
